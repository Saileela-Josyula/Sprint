...
public class Test4 {
	...
	public static void main(String[] args) {
		...
		Courier courier=new Courier(CourierStatus.delivered,null,null,LocalDate.parse("2021-03-27"),LocalDate.now());
		Courier courier2=new Courier(CourierStatus.delivered,null,null,LocalDate.parse("2021-03-24"),LocalDate.parse("2021-04-15"));
